...
echo ""
echo -e "  3. ${YELLOW}Update URL is set via browser policy (ExtensionInstallForcelist), not in the manifest.${NC}"
echo -e "     See docs/SETUP.md for enterprise policy configuration."
echo ""
