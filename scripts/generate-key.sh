...
echo ""
echo -e "  3. ${YELLOW}Keep the browser policy and manifest update URL aligned.${NC}"
echo -e "     ExtensionInstallForcelist bootstraps install, and extension/manifest.json embeds the same update_url for later update checks."
echo -e "     See docs/SETUP.md for the current update contract and enterprise policy configuration."
echo ""
